...
class PaymentForm(forms.Form):
    ...
    currency = forms.CharField(widget=forms.Select(attrs={'class': 'form-control select-data mb-3'}, choices=[]), required=False, label='Select the currency')
    ...
    credit_card_amount = forms.FloatField(widget=forms.NumberInput(attrs={'placeholder': 'The sum paid by credit card', 'class': 'form-control mb-3'}), required=False, label='')
    ...
    debit_card_amount = forms.FloatField(widget=forms.NumberInput(attrs={'placeholder': 'The sum paid by debit card', 'class': 'form-control mb-3'}), required=False, label='')
    cash_amount = forms.FloatField(widget=forms.NumberInput(attrs={'placeholder': 'The sum paid by cash', 'class': 'form-control mb-3'}), required=False, label='Cash')
